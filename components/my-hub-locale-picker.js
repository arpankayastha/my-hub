/**
 * my-hub-locale-picker - Sprachauswahl-Web-Component
...
import { t, setLocale, getLocale, getSupportedLocales } from '/my-hub/i18n.js';
...
class MyHubLocalePicker extends HTMLElement {
  connectedCallback() {
    this._render();
  ...
  _render() {
    const stored = localStorage.getItem('my-hub-locale');
    ...
    select.addEventListener('change', () => {
      ...
      if (select.value === 'system') {
        localStorage.removeItem('my-hub-locale');
...
customElements.define('my-hub-locale-picker', MyHubLocalePicker);

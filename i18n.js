...
const STORAGE_KEY = 'my-hub-locale';
const DATE_FORMAT_KEY = 'my-hub-date-format';
const TIME_FORMAT_KEY = 'my-hub-time-format';
const NUMBER_LOCALE_KEY = 'my-hub-number-locale';

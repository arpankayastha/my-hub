...
export function getBasePath() {
  ...
  const canonical =
    typeof window.__MY_HUB_CANONICAL_BASE__ === 'string'
      ? window.__MY_HUB_CANONICAL_BASE__
      : '';
  if (
    canonical
  ...
  return window.__MY_HUB_BASE__ || '';
}

/** Browser URL for an in-app route (e.g. /tasks → /my-hub/tasks). */

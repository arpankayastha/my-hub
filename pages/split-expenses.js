...
import { openModal as openSharedModal, closeModal, confirmModal } from '/my-hub/components/modal.js';
import { t, formatDate, getLocale, getNumberFormat, dateInputPlaceholder, parseDateInput, isDateInputValid } from '/my-hub/i18n.js';
import { esc } from '/my-hub/utils/html.js';
import { stagger } from '/my-hub/utils/ux.js';
    ...
    content: `
      <form id="split-expense-form" class="split-form">
        ...
        <div class="split-form-row">
          ...
          <label>${t('splitExpenses.date')}<my-hub-datepicker name="expense_date" type="date" value="${esc(isEdit ? (expense.expense_date || today) : today)}"></my-hub-datepicker></label>
        </div>

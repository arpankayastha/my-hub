...
import { t, getFormatLocale, formatDate } from '/my-hub/i18n.js';
...
import {
  ...
  wireBlurValidation,
  reportFieldError,
} from '/my-hub/components/modal.js';
...
import { emptyStateEl as emptyStateComponentEl, mountEmptyState } from '/my-hub/utils/empty-state.js';
import { scheduleUndoableDelete, vibrate, wireScrollFade } from '/my-hub/utils/ux.js';
import { toLocalDateKey } from '/my-hub/utils/date.js';
import { DEFAULT_CATEGORY_NAME, categoryLabel } from '/my-hub/utils/shopping-categories.js';
import { locationLabel } from '/my-hub/utils/pantry-locations.js';
import { PANTRY_UNITS, normalizePantryQuantity, pantryUnitStep } from '/my-hub/utils/pantry-units.js';
import {
  PANTRY_FILTERS,
  daysUntil,
  matchesPantryFilter,
  pantryFilterCounts,
  pantryItemStatus,
} from '/my-hub/utils/pantry-status.js';
...
async function openLocationManager() {
  await import('/my-hub/components/category-manager.js');

...
import { openModal as openSharedModal, closeModal, btnError, advancedSection, reportFieldError } from '/my-hub/components/modal.js';
import { stagger, vibrate, scheduleUndoableDelete } from '/my-hub/utils/ux.js';
import { t } from '/my-hub/i18n.js';
import { esc, renderMarkdownLight } from '/my-hub/utils/html.js';
    ...
    onSave(panel) {
      ...
      panel.querySelector('#note-modal-save').addEventListener('click', async () => {
        ...
        try {
          ...
          renderGrid();
          window.myHub?.showToast(mode === 'create' ? t('notes.createdToast') : t('notes.savedToast'), 'success');
        } catch (err) {

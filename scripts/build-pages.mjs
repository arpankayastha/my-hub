 ...
 * Rewrites root-absolute asset paths for project-site hosting (e.g. /my-hub/).
 */
import {
...
/** href/src only — inline <script> may use '/' + variable (must not become '/my-hub/' + seg). */
...
function injectCanonicalBase(html, basePath) {
  ...
  return html.replace(
    '(function () {\n      var canonical = window.__MY_HUB_CANONICAL_BASE__;',
    `(function () {\n      window.__MY_HUB_CANONICAL_BASE__='${basePath}';\n      var canonical = window.__MY_HUB_CANONICAL_BASE__;`,
  );
}

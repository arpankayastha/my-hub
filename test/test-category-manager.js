...
test('Definiert das Custom Element my-hub-category-manager', () => {
  assert(/customElements\.define\(\s*'my-hub-category-manager'/.test(comp), 'Tag-Name muss my-hub-category-manager sein');
});
...
test('Budget importiert die generische Komponente', () => {
  ...
  assert(/my-hub-category-manager/.test(budgetPage), 'budget.js muss das Element verwenden');
});

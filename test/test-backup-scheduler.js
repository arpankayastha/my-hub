...
describe('Backup Scheduler', () => {
  ...
  it('should create a backup file with timestamp', async () => {
    ...
    assert.ok(newFiles[0].startsWith('my-hub-backup-'), 'Backup file should have correct prefix');
  ...
  it('should rotate old backups (keep only last N)', async () => {
    ...
    const backupFiles = files.filter(f => f.startsWith('my-hub-backup-') && f.endsWith('.db'));

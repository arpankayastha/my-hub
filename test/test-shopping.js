...
test('Shopping-Seite importiert den Category-Manager und öffnet ihn bei manage=categories', () => {
  ...
  assert(/my-hub-category-manager/.test(source), 'shopping.js muss das geteilte Custom Element verwenden');
...
test('Geteilter Category-Manager erfüllt die Web-Component-Verträge (Einkauf, Audit F-15)', () => {
  ...
  assert(/customElements\.define\(\s*'my-hub-category-manager'/.test(source), 'Tag-Name muss my-hub-category-manager sein');

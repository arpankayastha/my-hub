...
## Added
- New dashboard changelog modal ([#455](https://github.com/arpankayastha/my-hub/pull/455))
- Internal commit 9f4a12bc should not leak

## Fixed
- Better widget sizing

Full Changelog: https://github.com/arpankayastha/my-hub/compare/v1.0.0...v1.1.0
Assets
`);
...
test('changelog router fetches and sanitizes GitHub release JSON', async () => {
  ...
  app.use(buildRouter({
    ...
    fetchFn: async (url, options) => {
      assert.match(url, /api\.github\.com\/repos\/arpankayastha\/my-hub\/releases/);
        ...
        json: async () => [
          {
            ...
            html_url: 'https://github.com/arpankayastha/my-hub/releases/tag/v1.2.1',
          },
        ],
      };
    },

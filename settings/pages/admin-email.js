 ...
 */
import { email } from '/my-hub/api.js';
import { t } from '/my-hub/i18n.js';
import { esc } from '/my-hub/utils/html.js';
import { createInlineError } from '/my-hub/settings/components.js';

const DEFAULTS = {
  host: '', port: 587, secure: 'starttls', user: '',
  fromAddress: '', fromName: 'My Hub', passwordSet: false,
};
...
export async function render(container, { user } = {}) {
  ...
  const showSuccess = (msg) => {
    ...
    window.myHub?.showToast(msg, 'success');
  };

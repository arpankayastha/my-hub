...
function showToast(message, tone = "default") {
  window.myHub?.showToast(message, tone);
}
...
function buildDriveSetupHint() {
  ...
  link.href =
    "https://github.com/arpankayastha/my-hub/blob/main/docs/installation.md#google-drive-document-storage-optional";
  link.target = "_blank";
...
function buildGoogleDriveProvider(data, reload) {
  ...
  provider.appendChild(
    createInfoList([
      ...
      { label: t("settings.documentStorageGoogleDriveFolder"), value: drive.folder_name || "My Hub/Documents" },

...
const SETTINGS_NOTICE_KEY = 'myhub:settings:notice';
        ...
        <form id="profile-form" class="settings-form">
          ...
          <fieldset class="settings-fieldset">
            ...
            <div class="form-group">
              ...
              <my-hub-datepicker type="date" id="profile-birth-date" value="${esc(user?.birth_date || '')}" aria-describedby="profile-error"></my-hub-datepicker>
...
function bindEvents(container, user, profileState) {
  ...
  profileForm?.addEventListener('submit', async (event) => {
    ...
    try {
      ...
      window.myHub?.showToast(t('settings.profileSavedToast'), 'success');
    } catch (error) {
      showError(profileError, error.message);
    } finally {
  ...
  passwordForm?.addEventListener('submit', async (event) => {
    ...
    try {
      ...
      passwordForm.reset();
      window.myHub?.showToast(t('settings.passwordSavedToast'), 'success');
    } catch (error) {

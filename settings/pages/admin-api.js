      ...
      <div class="settings-card">
        ...
        <form id="api-token-form" class="settings-form" autocomplete="off">
          ...
          <div class="form-group">
            ...
            <my-hub-datepicker type="datetime" id="api-token-expires"></my-hub-datepicker>
...
function bindEvents(container, initialTokens) {
  ...
  form.addEventListener('submit', async (event) => {
    ...
    try {
      ...
      outputValue.focus();
      outputValue.select();
      window.myHub?.showToast(t('settings.apiTokenCreatedToast'), 'success');
    } catch (err) {
  ...
  container.querySelector('#api-token-copy')?.addEventListener('click', async () => {
    ...
    try {
      ...
      window.myHub?.showToast(t('settings.apiTokenCopied'), 'success');
    } catch (err) {
  ...
  list.addEventListener('click', async (event) => {
    ...
    try {
      ...
      renderApiTokenList(container, tokens);
      window.myHub?.showToast(t('settings.apiTokenRevokedToast'), 'default');
    } catch (err) {

...
import { closeModal, confirmModal, openModal } from '/my-hub/components/modal.js';
import {
  createDisclosure,
  createInlineError,
  createRetryState,
...
import { withBusy } from '/my-hub/utils/ux.js';
    ...
    if (user?.role === 'admin') {
      ...
      disconnectBtn.addEventListener('click', async () => {
        ...
        try {
          ...
          window.myHub?.navigate('/settings/sync/calendar');
        } catch (err) {
          showToast(err.message || t('common.errorGeneric'), 'danger');
        }
      });
